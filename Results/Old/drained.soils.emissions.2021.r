...
#Printing results for South and North Finland by forest peatland types, t C
write.csv(emis.sf.lu, (paste(resultspath,"emis.sf",yr,".csv", sep="")))
write.csv(emis.nf.lu, (paste(resultspath,"emis.nf",yr,".csv", sep="")))
...
write.table(LU4A21.organic.soil, paste(crf,"LU4A1_FL-FL_Organic_soil_current.csv", sep=""), sep=" ", row.names = TRUE, col.names = FALSE, quote=FALSE)
