...
emis.lu.sf <- colSums(emis.sf.lu)
emis.lu.nf <- colSums(emis.nf.lu)
...
LU4A21.organic.soil.sf <- t(round(emis.lu.sf/1000,3))
LU4A21.organic.soil.nf <- t(round(emis.lu.nf/1000,3))
...
write.table(LU4A21.organic.soil.sf, paste(resultspath,"sf_FL-FL_Organic_soil.csv", sep=""), sep=" ", row.names = TRUE, col.names = FALSE, quote=FALSE)
write.table(LU4A21.organic.soil.nf, paste(resultspath,"nf_FL-FL_Organic_soil.csv", sep=""), sep=" ", row.names = TRUE, col.names = FALSE, quote=FALSE)
